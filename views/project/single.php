    ...
    <header class="main-content-header">
        ...
        <div class="header-content">
            ...
            <?php if($this->isEditable() || $entity->num_sniic): ?>
                <p class="num_sniic"><span class="label">Nº SNIIC:</span> <span id="num-sniic"><?php echo $entity->num_sniic ? $entity->num_sniic : "Preencha os campos obrigatórios e clique em salvar para gerar"; ?></span></p>
            <?php endif; ?>
        </div>
    </header>
...
<div class="sidebar-left sidebar project">
    <?php $this->part('related-seals', array('entity'=>$entity)); ?>
