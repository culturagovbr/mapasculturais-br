...
class Theme extends BaseMinc\Theme{
    ...
    protected static function _getTexts(){
        return array(
            ...
            'home: welcome' => "<p>O Mapa da Cultura é um espaço para integrar e dar visibilidade para projetos, artistas, espaços, eventos culturais e seus produtores. Ele é a principal base de informações e indicadores do Ministério da Cultura, se constituindo <a href='http://i.cultura.gov.br'>o pilar principal do SNIIC</a>. </p>
             <p> Neste mapa estão reunidas informações do antigo Registro Aberto da Cultura - RAC, da <a href='http://culturaviva.gov.br'>Rede Cultura Viva</a>, do <a href='http://bibliotecas.cultura.gov.br'>Sistema Nacional de Bibliotecas Públicas - SNBP</a> e do <a href='http://museus.cultura.gov.br'>Cadastro Nacional de Museus</a>. </p>
